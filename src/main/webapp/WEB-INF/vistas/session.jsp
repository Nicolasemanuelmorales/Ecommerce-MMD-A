    		...
    		<div class="row">
    			<div class="col-md-8 col-lg-10 order-md-last">
    				...
    				<div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
		    				<div class="product">
		    					<a href="${context}/detalleProducto/${i.id}" class="img-prod"><img class="img-fluid" src="${context}/ ${i.imagen}" alt="Colorlib Template">
		    					...
		    					<div class="text py-3 px-3">
			    					...
			    					<p class="bottom-area d-flex px-3">
			    						<a href="${context}/agregarAlCarro2/${i.id}" class="add-to-cart text-center py-2">Carro<span><i class="ion-ios-cart ml-1"></i></span></a>
		    							<a href="${context}/detalleProducto2/${i.id}/${i.tipo.nombre}" class="buy-now text-center py-2 mr-1"><span>Detalle<i class="ion-ios-add ml-1"></i></span></a>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
